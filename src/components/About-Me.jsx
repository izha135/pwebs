        ...
        <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12 px-5 py-4">
          <div className="  ">
            ...
            <p className="xl-s:text-left md-s:text-center  font-poppins text-xl ">
              My name is Isha Chauhan. I recently graduated with a bachelors
              degree in Computer Science with a Minor in Mathematics from the
              University of New Mexico. I'm passionate about development and
              learning new things as well as stepping out of my comfort zone. My
              goal is to pursue a successful career in the field of Computer
              Science. I spend my free time coding new projects and learning new
              tech stacks on the way, and I also enjoy weightlifting! <br />I
              currently hold an IT Intern position at the State of New Mexico.
              <br />
              Please do feel free to take a look at my resume if you are a
              recruiter or know of any opportunities I could potentially grab.
