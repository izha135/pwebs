  ...
  return (
    <section className="xl-s:ml-[6rem] md-s:ml-[2rem] md-s:mr-[2rem] md-s:mt-[3rem] md-s:object-center">
      <div className="container grid xl-s:grid-cols-2 md-s:grid-cols-1 rounded-xl bg-gradient-to-t from-[#fbc2eb] to-[#a6c1ee]  shadow-xl shadow-purple-500/40 xl-s:px-[3rem]  flex-col-reverse lg-s:flex-row items-center xl-s:mr-[12rem]  gap-12 mt:5 lg-s:mt-10 sm-s:mt-10 lg-s:ml-16 ">
        ...
        <div className=" flex-wrap xl-s:mt-[5rem]  xl-s:w-[28rem] md-s:ml-[15rem] lg-s:text-center md-s:mr-[13rem] sm-s:w-4/12 sm-s:ml-[9rem] px-4 sm-s:mb-0 md:mb-0 lg-mb-0 ">
          <img
        ...
        <div className="inline-block md-s:ml-[3rem] px-1 xl-s:ml-[4rem] w-full gap-0 xl-s:-mt-[6rem] sm-s:mt-[1rem] mb-10">
          ...
          <button className=" bg-purple-400 w-[7rem] xl-s:-ml-[36rem] xl-s:mt-6 md-s:ml-[18rem] md-s:mt-5 hover:bg-purple-600 text-white font-bold py-2 mb-12 xl-s:px-4 sm-s:mt-10 rounded">
            <h1>Resume</h1>
          </button>
        </div>
      </div>
